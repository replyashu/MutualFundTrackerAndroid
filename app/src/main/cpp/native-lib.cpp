...
Java_com_ashu_mftracker_util_Keys_webClientKey(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_ashu_mftracker_util_Keys_notificationChannel(JNIEnv *env, jobject thiz) {
    std::string notification_channel = "mutual_fund_notification";
    return env->NewStringUTF(notification_channel.c_str());
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_ashu_mftracker_util_Keys_notificationChannelDescription(JNIEnv *env, jobject thiz) {
